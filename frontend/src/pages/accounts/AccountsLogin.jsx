...
const AccountsLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      ...
      if (savedUser && savedUser.role !== 'Accounts') {
        await logout();
        toast.error('Access Denied: This login page is only for Accounts Team');
        setSubmitting(false);
        return;
      }
      toast.success('Logged in successfully as Accounts Team!');
    } else {
    ...
    <div className="container-fluid min-vh-100 d-flex align-items-center justify-content-center bg-light">
      <div className="card shadow-lg border-0 glass-card p-4" style={{ maxWidth: '420px', width: '100%' }}>
        <div className="text-center mb-4">
          ...
          <h2 className="fw-bold mb-1">Accounts Portal</h2>
          <p className="text-muted small">Sign in to review and authorize payouts</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <div className="d-flex justify-content-between align-items-center mb-1">
              ...
              <Link to="/forgot-password?portal=Accounts" style={{ color: '#198754', fontSize: '0.825rem' }} className="text-decoration-none hover-link">Forgot Password?</Link>
            </div>
            <div className="input-group">
